...
public class CommentService {
	...
	public Comment getComment(long messageId, long commentId) {
		...
		ErrorMessage errorMessage  = new ErrorMessage("Not Found", 404, "provide documentation link");
		...
		if (comment == null) {
			throw new NotFoundException(response); //it replaces the above response code
		}
		return comment;
	}
